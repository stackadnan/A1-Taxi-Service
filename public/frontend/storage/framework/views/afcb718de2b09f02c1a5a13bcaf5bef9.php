            ...
            <div class="row g-5">
                <div class="col-lg-8">
                    <div class="car-details-items">
                        <div class="car-image">
                            <img src="<?php echo e(\App\Support\GalleryPath::path('i/26')); ?>" alt="img">
                        </div>
                        <div class="car-content">
                            ...
                            <div class="icon-details-area">
                                ...
                                <div class="icon-details-main-items">
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="<?php echo e(\App\Support\GalleryPath::path('i/27')); ?>" alt="img">
                                        </div>
                                        <div class="content">
                                            <h6>body:</h6>
                                            <p>Sedan</p>
                                ...
                                <div class="icon-details-main-items">
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="<?php echo e(\App\Support\GalleryPath::path('i/28')); ?>" alt="img">
                                        </div>
                                        <div class="content">
                                            <h6>Passengers:</h6>
                                            <p>6 Seats</p>
                                    ...
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="<?php echo e(\App\Support\GalleryPath::path('i/29')); ?>" alt="img">
                                        </div>
                                        <div class="content">
                                            <h6>Gear:</h6>
                                            <p>Automatic</p>
                                    ...
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="<?php echo e(\App\Support\GalleryPath::path('i/30')); ?>" alt="img">
                                        </div>
                                        <div class="content">
                                            <h6>Gear:</h6>
                                            <p>Automatic</p>
                                    ...
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="<?php echo e(\App\Support\GalleryPath::path('i/31')); ?>" alt="img">
                                        </div>
                                        <div class="content">
                                            <h6>Fuel:</h6>
                                            <p>Petrol</p>
                            ...
                            <div class="car-video">
                                <img src="<?php echo e(\App\Support\GalleryPath::path('i/32')); ?>" alt="img">
                                <div class="video-box">
                    ...
                    <div class="comment-reviews">
                        ...
                        <div class="car-single-comment d-flex gap-4 pb-5">
                            <div class="image">
                                <img src="<?php echo e(\App\Support\GalleryPath::path('i/33')); ?>" alt="image">
                            </div>
                            <div class="content">
                        ...
                        <div class="car-single-comment d-flex gap-4 pt-5 border-none">
                            <div class="image">
                                <img src="<?php echo e(\App\Support\GalleryPath::path('i/34')); ?>" alt="image">
                            </div>
                            <div class="content">
                                <div class="head d-flex flex-wrap gap-3 align-items-center justify-content-between">
                                    <div class="con">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                <div class="car-rentals-items">
                    <div class="car-image">
                        <img src="<?php echo e(\App\Support\GalleryPath::path('i/35')); ?>" alt="img">
                    </div>
                    <div class="car-content">
                        <div class="post-cat">
                            2024 Model
                        ...
                        <div class="icon-items">
                            <ul>
                                <li>
                                    <img src="<?php echo e(\App\Support\GalleryPath::path('i/29')); ?>" alt="img" class="me-1">
                                    6 Seats
                                </li>
                                <li>
                                    <img src="<?php echo e(\App\Support\GalleryPath::path('i/28')); ?>" alt="img" class="me-1">
                                    2 Doors
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <img src="<?php echo e(\App\Support\GalleryPath::path('i/30')); ?>" alt="img" class="me-1">
                                    Automatic
                                </li>
                                <li>
                                    <img src="<?php echo e(\App\Support\GalleryPath::path('i/31')); ?>" alt="img" class="me-1">
                                    Petrol
                                </li>
                            </ul>
                        </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                <div class="car-rentals-items">
                    <div class="car-image">
                        <img src="<?php echo e(\App\Support\GalleryPath::path('i/36')); ?>" alt="img">
                    </div>
                    <div class="car-content">
                        <div class="post-cat">
                            2024 Model
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                <div class="car-rentals-items">
                    <div class="car-image">
                        <img src="<?php echo e(\App\Support\GalleryPath::path('i/37')); ?>" alt="img">
                    </div>
                    <div class="car-content">
                        <div class="post-cat">
                            2024 Model
...
<?php /**PATH /home/executiveairport/public_html/frontend/resources/views/car-details.blade.php ENDPATH**/ ?>