...
<script>
  ...
  function renderSummary() {
    ...
    html += '<div id="sbFareSummary">'
      ...
      + '<span class="sb-fare-label">Calculating price...</span>'
      + '<span class="sb-fare-amount">...</span>'
      + '</div>'
      + '</div>';
    ...
    calculatePricingSummary(baseFare, meetFee).then(function(calc) {
      ...
      summaryHtml += '<div class="sb-fare-row" style="border-top:1px solid rgba(0,0,0,0.08);">'
        ...
        + '<span class="sb-fare-amount">£ ' + calc.vatAmount.toFixed(2) + '</span>'
        + '</div>';

      if (calc.meetFee > 0) {
        summaryHtml += '<div class="sb-fare-row" style="border-top:1px solid rgba(0,0,0,0.08);">'
          + '<span class="sb-fare-label">Meet &amp; Greet</span>'
          + '<span class="sb-fare-amount">£ ' + calc.meetFee.toFixed(2) + '</span>'
          + '</div>';
      }

      summaryHtml += '<div class="sb-fare-row" style="margin-top:12px; background: var(--primary-light); border-radius: 10px; padding: 14px 16px;">'
        + '<span class="sb-fare-label" style="color: var(--primary);">Total</span>'
        + '<span class="sb-fare-amount" style="color: var(--primary); font-size: 28px;">£ ' + calc.total.toFixed(2) + '</span>'
        + '</div>';
