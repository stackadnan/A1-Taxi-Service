    ...
    <script>
        window.GALLERY_IMAGE_ID_MAP = <?php echo json_encode($galleryImageIdMap ?? [], 15, 512) ?>;
        window.GALLERY_IMAGE_PATH_MAP = <?php echo json_encode($galleryImagePathMap ?? [], 15, 512) ?>;
...
<?php /**PATH /home/executiveairport/public_html/frontend/resources/views/partials/script.blade.php ENDPATH**/ ?>