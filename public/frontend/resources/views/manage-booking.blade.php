                ...
                <div class="mt-5 pt-5 mb-4">
                    ...
                    <div class="card border-0 shadow-lg rounded-4">
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('manage-booking.lookup') }}" method="POST">
                                @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" name="booking_email"
                                               ...
                                               value="{{ old('booking_email', $lookupInput['booking_email'] ?? '') }}"
                                               required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="booking_reference"
                                               ...
                                               value="{{ old('booking_reference', $lookupInput['booking_reference'] ?? '') }}"
                                               required>
                                    </div>
                    ...
                    <div class="card border-0 shadow-lg rounded-4">
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('manage-booking.update') }}" method="POST">
                                ...
                                <input type="hidden" name="booking_email_lookup" value="{{ old('booking_email_lookup', $lookupInput['booking_email'] ?? $booking->email ?? '') }}">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="passenger_name" class="form-control"
                                               value="{{ old('passenger_name', $formData['passenger_name'] ?? $booking->passenger_name) }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Email</label>
                                        <input type="email" name="email" class="form-control"
                                               value="{{ old('email', $formData['email'] ?? $booking->email) }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Phone</label>
                                        <input type="text" name="phone" class="form-control"
                                               value="{{ old('phone', $formData['phone'] ?? $booking->phone) }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Passengers</label>
                                        <input type="number" name="passengers_count" class="form-control"
                                               value="{{ old('passengers_count', $formData['passengers_count'] ?? $booking->passengers_count) }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Luggage</label>
                                        <input type="number" name="luggage_count" class="form-control"
                                               value="{{ old('luggage_count', $formData['luggage_count'] ?? $booking->luggage_count) }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Pickup Time</label>
                                        <input type="time" name="pickup_time" class="form-control"
                                               value="{{ old('pickup_time', $booking->pickup_time ? substr($booking->pickup_time,0,5) : '') }}">
                                    </div>
...
{{ old('message_to_driver', $booking->message_to_driver) }}
                                        </textarea>
                                    </div>
