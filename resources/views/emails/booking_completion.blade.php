      ...
      <table width="520" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border-radius:24px;overflow:hidden;max-width:520px;">
        <tr>
          <td style="background:#008B9E;padding:24px;text-align:center;color:#ffffff;">
            ...
            <div style="display:inline-block;background:rgba(255,255,255,0.18);border:1px solid rgba(255,255,255,0.25);border-radius:30px;padding:8px 18px;font-size:13px;font-weight:700;">Booking Completed</div>
          </td>
        </tr>
        <tr>
          <td style="padding:24px;">
            <p style="font-size:15px;font-weight:700;color:#192335;margin:0 0 16px 0;">Dear {{ $booking->passenger_name ?: 'Customer' }},</p>
            <p style="font-size:14px;color:#374151;line-height:1.7;margin:0 0 18px 0;">Your booking has been completed successfully. Please find your journey summary below.</p>
            ...
            <p style="font-size:14px;color:#374151;line-height:1.7;margin:0 0 24px 0;">{{ $booking->message_to_passenger ?: 'Thank you for choosing A1 Airport Cars. We hope you had a great journey.' }}</p>
